# Car Purchase Propensity with XGBoost
...
Purchase propensity, gradient boosting and predictive modeling. This project was organized as a portfolio-ready case study: it explains the objective, the analytical path, the visual evidence and the practical interpretation behind the result.

Main objective: Predict which customers are more likely to buy a car using XGBoost and structured customer attributes.

**PT-BR**

Propensao de compra, gradient boosting e modelagem preditiva. Este projeto foi organizado como um estudo de caso pronto para portfolio: explica o objetivo, o caminho analitico, as evidencias visuais e a interpretacao pratica por tras do resultado.

Objetivo principal: Prever quais clientes tem maior probabilidade de comprar um carro usando XGBoost e atributos estruturados.
